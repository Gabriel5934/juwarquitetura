  ...
  component: () => {
    ...
    return (
      <div className="w-screen flex flex-col items-center">
        ...
        />
        {/* Navbar */}
        <div className="bg-green flex justify-between items-center lg:px-8 lg:py-4 w-full">
          <svg
            viewBox="0 0 70 70"
            fill="none"
        ...
        {/* Hero */}
        <div className="flex flex-col justify-center text-center gap-8 bg-darkBase h-[350px] lg:h-[700px] w-full">
          <img
            src={Hero}
            alt=""
        ...
        {/* Catalog */}
        <div className="flex items-start gap-4 lg:gap-8 mt-8 px-4">
          <div className="bg-darkBase bg-no-repeat bg-cover flex flex-col gap-2 relative overflow-clip mt-8 lg:mb-16">
        ...
        <div className="max-w-[1000px] bg-lightBase rounded-xl py-8  w-full">
          <div className="carouselContainer">
            ...
            <Carousel
              ...
              centerMode={true}
              infinite
              responsive={carouselResponsive(3, 6, 2)}
              swipeable
              minimumTouchDrag={0}
            >
              <img alt="" src={bath1} />
          ...
          <div className="flex flex-col justify-center py-16 bg-cover bg-center gap-2 h-[200px] lg:h-[400px]">
            ...
            <img
              src={HappyCouple}
              alt=""
              className="absolute object-cover w-screen z-0 h-[200px] lg:h-[400px] object-top lg:object-left-top max-w-[1000px]"
              style={{
        ...
        <div className="bg-green px-4 lg:px-16 py-16 flex flex-col gap-8 w-full">
