  ...
  component: () => (
    <>
      ...
      >
        ...
        <div>
          <a href="https://wa.me/5512991820133">
      ...
      <div
        className="bg-darkBase bg-no-repeat bg-cover"
        style={{
      ...
      >
        <div className="flex flex-col p-4 gap-2">
          ...
          <div>
            <button className="btn btn-primary uppercase">eu quero!</button>
          </div>
        </div>
      </div>
      <div className="bg-lightBase">
      ...
      <div className="bg-blue px-4 py-16 flex flex-col gap-8">
